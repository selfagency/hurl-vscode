...
- [Hurl Documentation](#hurl-documentation)
  - [Version 7.1.0 - 21-11-2025](#version-710---21-11-2025)
- [Table of Contents](#table-of-contents)
- [Introduction {#introduction}](#introduction-introduction)
  - [What's Hurl? {#introduction-home-whats-hurl}](#whats-hurl-introduction-home-whats-hurl)
  - [Also an HTTP Test Tool {#introduction-home-also-an-http-test-tool}](#also-an-http-test-tool-introduction-home-also-an-http-test-tool)
  - [Why Hurl? {#introduction-home-why-hurl}](#why-hurl-introduction-home-why-hurl)
  - [Powered by curl {#introduction-home-powered-by-curl}](#powered-by-curl-introduction-home-powered-by-curl)
  - [Feedbacks {#introduction-home-feedbacks}](#feedbacks-introduction-home-feedbacks)
  - [Resources {#introduction-home-resources}](#resources-introduction-home-resources)
- [Getting Started {#getting-started}](#getting-started-getting-started)
  - [Installation {#getting-started-installation-installation}](#installation-getting-started-installation-installation)
    - [Binaries Installation {#getting-started-installation-binaries-installation}](#binaries-installation-getting-started-installation-binaries-installation)
      - [Linux {#getting-started-installation-linux}](#linux-getting-started-installation-linux)
        - [Debian / Ubuntu {#getting-started-installation-debian--ubuntu}](#debian--ubuntu-getting-started-installation-debian--ubuntu)
        - [Alpine {#getting-started-installation-alpine}](#alpine-getting-started-installation-alpine)
        - [Arch Linux / Manjaro {#getting-started-installation-arch-linux--manjaro}](#arch-linux--manjaro-getting-started-installation-arch-linux--manjaro)
        - [NixOS / Nix {#getting-started-installation-nixos--nix}](#nixos--nix-getting-started-installation-nixos--nix)
      - [macOS {#getting-started-installation-macos}](#macos-getting-started-installation-macos)
        - [Homebrew {#getting-started-installation-homebrew}](#homebrew-getting-started-installation-homebrew)
        - [MacPorts {#getting-started-installation-macports}](#macports-getting-started-installation-macports)
      - [FreeBSD {#getting-started-installation-freebsd}](#freebsd-getting-started-installation-freebsd)
      - [Windows {#getting-started-installation-windows}](#windows-getting-started-installation-windows)
        - [Zip File {#getting-started-installation-zip-file}](#zip-file-getting-started-installation-zip-file)
        - [Installer {#getting-started-installation-installer}](#installer-getting-started-installation-installer)
        - [Chocolatey {#getting-started-installation-chocolatey}](#chocolatey-getting-started-installation-chocolatey)
        - [Scoop {#getting-started-installation-scoop}](#scoop-getting-started-installation-scoop)
        - [Windows Package Manager {#getting-started-installation-windows-package-manager}](#windows-package-manager-getting-started-installation-windows-package-manager)
      - [Cargo {#getting-started-installation-cargo}](#cargo-getting-started-installation-cargo)
      - [conda-forge {#getting-started-installation-conda-forge}](#conda-forge-getting-started-installation-conda-forge)
      - [Docker {#getting-started-installation-docker}](#docker-getting-started-installation-docker)
      - [npm {#getting-started-installation-npm}](#npm-getting-started-installation-npm)
    - [Building From Sources {#getting-started-installation-building-from-sources}](#building-from-sources-getting-started-installation-building-from-sources)
      - [Build on Linux {#getting-started-installation-build-on-linux}](#build-on-linux-getting-started-installation-build-on-linux)
        - [Debian based distributions {#getting-started-installation-debian-based-distributions}](#debian-based-distributions-getting-started-installation-debian-based-distributions)
        - [Fedora based distributions {#getting-started-installation-fedora-based-distributions}](#fedora-based-distributions-getting-started-installation-fedora-based-distributions)
        - [Red Hat based distributions {#getting-started-installation-red-hat-based-distributions}](#red-hat-based-distributions-getting-started-installation-red-hat-based-distributions)
        - [Arch based distributions {#getting-started-installation-arch-based-distributions}](#arch-based-distributions-getting-started-installation-arch-based-distributions)
        - [Alpine based distributions {#getting-started-installation-alpine-based-distributions}](#alpine-based-distributions-getting-started-installation-alpine-based-distributions)
      - [Build on macOS {#getting-started-installation-build-on-macos}](#build-on-macos-getting-started-installation-build-on-macos)
      - [Build on Windows {#getting-started-installation-build-on-windows}](#build-on-windows-getting-started-installation-build-on-windows)
  - [Manual {#getting-started-manual-manual}](#manual-getting-started-manual-manual)
    - [Name {#getting-started-manual-name}](#name-getting-started-manual-name)
    - [Synopsis {#getting-started-manual-synopsis}](#synopsis-getting-started-manual-synopsis)
    - [Description {#getting-started-manual-description}](#description-getting-started-manual-description)
    - [Hurl File Format {#getting-started-manual-hurl-file-format}](#hurl-file-format-getting-started-manual-hurl-file-format)
      - [Capturing values {#getting-started-manual-capturing-values}](#capturing-values-getting-started-manual-capturing-values)
      - [Asserts {#getting-started-manual-asserts}](#asserts-getting-started-manual-asserts)
    - [Options {#getting-started-manual-options}](#options-getting-started-manual-options)
    - [Environment {#getting-started-manual-environment}](#environment-getting-started-manual-environment)
    - [Exit Codes {#getting-started-manual-exit-codes}](#exit-codes-getting-started-manual-exit-codes)
    - [WWW {#getting-started-manual-www}](#www-getting-started-manual-www)
    - [See Also {#getting-started-manual-see-also}](#see-also-getting-started-manual-see-also)
  - [Samples {#getting-started-samples-samples}](#samples-getting-started-samples-samples)
    - [Getting Data {#getting-started-samples-getting-data}](#getting-data-getting-started-samples-getting-data)
      - [HTTP Headers {#getting-started-samples-http-headers}](#http-headers-getting-started-samples-http-headers)
      - [Query Params {#getting-started-samples-query-params}](#query-params-getting-started-samples-query-params)
      - [Basic Authentication {#getting-started-samples-basic-authentication}](#basic-authentication-getting-started-samples-basic-authentication)
      - [Passing Data between Requests {#getting-started-samples-passing-data-between-requests}](#passing-data-between-requests-getting-started-samples-passing-data-between-requests)
    - [Sending Data {#getting-started-samples-sending-data}](#sending-data-getting-started-samples-sending-data)
      - [Sending HTML Form Data {#getting-started-samples-sending-html-form-data}](#sending-html-form-data-getting-started-samples-sending-html-form-data)
      - [Sending Multipart Form Data {#getting-started-samples-sending-multipart-form-data}](#sending-multipart-form-data-getting-started-samples-sending-multipart-form-data)
      - [Posting a JSON Body {#getting-started-samples-posting-a-json-body}](#posting-a-json-body-getting-started-samples-posting-a-json-body)
      - [Templating a JSON Body {#getting-started-samples-templating-a-json-body}](#templating-a-json-body-getting-started-samples-templating-a-json-body)
      - [Templating a XML Body {#getting-started-samples-templating-a-xml-body}](#templating-a-xml-body-getting-started-samples-templating-a-xml-body)
      - [Using GraphQL Query {#getting-started-samples-using-graphql-query}](#using-graphql-query-getting-started-samples-using-graphql-query)
      - [Using Dynamic Datas {#getting-started-samples-using-dynamic-datas}](#using-dynamic-datas-getting-started-samples-using-dynamic-datas)
    - [Testing Response {#getting-started-samples-testing-response}](#testing-response-getting-started-samples-testing-response)
      - [Testing Status Code {#getting-started-samples-testing-status-code}](#testing-status-code-getting-started-samples-testing-status-code)
      - [Testing Response Headers {#getting-started-samples-testing-response-headers}](#testing-response-headers-getting-started-samples-testing-response-headers)
      - [Testing REST APIs {#getting-started-samples-testing-rest-apis}](#testing-rest-apis-getting-started-samples-testing-rest-apis)
      - [Testing HTML Response {#getting-started-samples-testing-html-response}](#testing-html-response-getting-started-samples-testing-html-response)
      - [Testing Set-Cookie Attributes {#getting-started-samples-testing-set-cookie-attributes}](#testing-set-cookie-attributes-getting-started-samples-testing-set-cookie-attributes)
      - [Testing Bytes Content {#getting-started-samples-testing-bytes-content}](#testing-bytes-content-getting-started-samples-testing-bytes-content)
      - [SSL Certificate {#getting-started-samples-ssl-certificate}](#ssl-certificate-getting-started-samples-ssl-certificate)
      - [Checking Full Body {#getting-started-samples-checking-full-body}](#checking-full-body-getting-started-samples-checking-full-body)
      - [Testing Redirections {#getting-started-samples-testing-redirections}](#testing-redirections-getting-started-samples-testing-redirections)
    - [Debug Tips {#getting-started-samples-debug-tips}](#debug-tips-getting-started-samples-debug-tips)
      - [Verbose Mode {#getting-started-samples-verbose-mode}](#verbose-mode-getting-started-samples-verbose-mode)
      - [Error Format {#getting-started-samples-error-format}](#error-format-getting-started-samples-error-format)
      - [Output Response Body {#getting-started-samples-output-response-body}](#output-response-body-getting-started-samples-output-response-body)
      - [Export curl Commands {#getting-started-samples-export-curl-commands}](#export-curl-commands-getting-started-samples-export-curl-commands)
      - [Using Proxy {#getting-started-samples-using-proxy}](#using-proxy-getting-started-samples-using-proxy)
    - [Reports {#getting-started-samples-reports}](#reports-getting-started-samples-reports)
      - [HTML Report {#getting-started-samples-html-report}](#html-report-getting-started-samples-html-report)
      - [JSON Report {#getting-started-samples-json-report}](#json-report-getting-started-samples-json-report)
      - [JUnit Report {#getting-started-samples-junit-report}](#junit-report-getting-started-samples-junit-report)
      - [TAP Report {#getting-started-samples-tap-report}](#tap-report-getting-started-samples-tap-report)
      - [JSON Output {#getting-started-samples-json-output}](#json-output-getting-started-samples-json-output)
    - [Others {#getting-started-samples-others}](#others-getting-started-samples-others)
      - [HTTP Version {#getting-started-samples-http-version}](#http-version-getting-started-samples-http-version)
      - [IP Address {#getting-started-samples-ip-address}](#ip-address-getting-started-samples-ip-address)
      - [Polling and Retry {#getting-started-samples-polling-and-retry}](#polling-and-retry-getting-started-samples-polling-and-retry)
      - [Delaying Requests {#getting-started-samples-delaying-requests}](#delaying-requests-getting-started-samples-delaying-requests)
      - [Skipping Requests {#getting-started-samples-skipping-requests}](#skipping-requests-getting-started-samples-skipping-requests)
      - [Testing Endpoint Performance {#getting-started-samples-testing-endpoint-performance}](#testing-endpoint-performance-getting-started-samples-testing-endpoint-performance)
      - [Using SOAP APIs {#getting-started-samples-using-soap-apis}](#using-soap-apis-getting-started-samples-using-soap-apis)
      - [Capturing and Using a CSRF Token {#getting-started-samples-capturing-and-using-a-csrf-token}](#capturing-and-using-a-csrf-token-getting-started-samples-capturing-and-using-a-csrf-token)
      - [Redacting Secrets {#getting-started-samples-redacting-secrets}](#redacting-secrets-getting-started-samples-redacting-secrets)
      - [Checking Byte Order Mark (BOM) in Response Body {#getting-started-samples-checking-byte-order-mark-bom-in-response-body}](#checking-byte-order-mark-bom-in-response-body-getting-started-samples-checking-byte-order-mark-bom-in-response-body)
      - [AWS Signature Version 4 Requests {#getting-started-samples-aws-signature-version-4-requests}](#aws-signature-version-4-requests-getting-started-samples-aws-signature-version-4-requests)
      - [Using curl Options {#getting-started-samples-using-curl-options}](#using-curl-options-getting-started-samples-using-curl-options)
  - [Running Tests {#getting-started-running-tests-running-tests}](#running-tests-getting-started-running-tests-running-tests)
    - [Use --test Option {#getting-started-running-tests-use-test-option}](#use---test-option-getting-started-running-tests-use-test-option)
      - [Selecting Tests {#getting-started-running-tests-selecting-tests}](#selecting-tests-getting-started-running-tests-selecting-tests)
    - [Debugging {#getting-started-running-tests-debugging}](#debugging-getting-started-running-tests-debugging)
      - [Debug Logs {#getting-started-running-tests-debug-logs}](#debug-logs-getting-started-running-tests-debug-logs)
      - [HTTP Responses {#getting-started-running-tests-http-responses}](#http-responses-getting-started-running-tests-http-responses)
    - [Stress and Performance Tests {#getting-started-running-tests-stress-and-performance-tests}](#stress-and-performance-tests-getting-started-running-tests-stress-and-performance-tests)
    - [Generating Report {#getting-started-running-tests-generating-report}](#generating-report-getting-started-running-tests-generating-report)
      - [HTML Report {#getting-started-running-tests-html-report}](#html-report-getting-started-running-tests-html-report)
      - [JSON Report {#getting-started-running-tests-json-report}](#json-report-getting-started-running-tests-json-report)
      - [JUnit Report {#getting-started-running-tests-junit-report}](#junit-report-getting-started-running-tests-junit-report)
      - [TAP Report {#getting-started-running-tests-tap-report}](#tap-report-getting-started-running-tests-tap-report)
    - [Use Variables in Tests {#getting-started-running-tests-use-variables-in-tests}](#use-variables-in-tests-getting-started-running-tests-use-variables-in-tests)
  - [Frequently Asked Questions {#getting-started-frequently-asked-questions-frequently-asked-questions}](#frequently-asked-questions-getting-started-frequently-asked-questions-frequently-asked-questions)
    - [General {#getting-started-frequently-asked-questions-general}](#general-getting-started-frequently-asked-questions-general)
      - [Why "Hurl"? {#getting-started-frequently-asked-questions-why-hurl}](#why-hurl-getting-started-frequently-asked-questions-why-hurl)
      - [Yet Another Tool, I already use X {#getting-started-frequently-asked-questions-yet-another-tool-i-already-use-x}](#yet-another-tool-i-already-use-x-getting-started-frequently-asked-questions-yet-another-tool-i-already-use-x)
      - [Hurl is build on top of libcurl, but what is added? {#getting-started-frequently-asked-questions-hurl-is-build-on-top-of-libcurl-but-what-is-added}](#hurl-is-build-on-top-of-libcurl-but-what-is-added-getting-started-frequently-asked-questions-hurl-is-build-on-top-of-libcurl-but-what-is-added)
      - [Why shouldn't I use Hurl? {#getting-started-frequently-asked-questions-why-shouldnt-i-use-hurl}](#why-shouldnt-i-use-hurl-getting-started-frequently-asked-questions-why-shouldnt-i-use-hurl)
      - [I have a large numbers of tests, how to run just specific tests? {#getting-started-frequently-asked-questions-i-have-a-large-numbers-of-tests-how-to-run-just-specific-tests}](#i-have-a-large-numbers-of-tests-how-to-run-just-specific-tests-getting-started-frequently-asked-questions-i-have-a-large-numbers-of-tests-how-to-run-just-specific-tests)
      - [How can I use my Hurl files outside Hurl? {#getting-started-frequently-asked-questions-how-can-i-use-my-hurl-files-outside-hurl}](#how-can-i-use-my-hurl-files-outside-hurl-getting-started-frequently-asked-questions-how-can-i-use-my-hurl-files-outside-hurl)
      - [Can I do calculation within a Hurl file? {#getting-started-frequently-asked-questions-can-i-do-calculation-within-a-hurl-file}](#can-i-do-calculation-within-a-hurl-file-getting-started-frequently-asked-questions-can-i-do-calculation-within-a-hurl-file)
    - [macOS {#getting-started-frequently-asked-questions-macos}](#macos-getting-started-frequently-asked-questions-macos)
      - [How can I use a custom libcurl (from Homebrew by instance)? {#getting-started-frequently-asked-questions-how-can-i-use-a-custom-libcurl-from-homebrew-by-instance}](#how-can-i-use-a-custom-libcurl-from-homebrew-by-instance-getting-started-frequently-asked-questions-how-can-i-use-a-custom-libcurl-from-homebrew-by-instance)
- [File Format {#file-format}](#file-format-file-format)
  - [Hurl File {#file-format-hurl-file-hurl-file}](#hurl-file-file-format-hurl-file-hurl-file)
    - [Character Encoding {#file-format-hurl-file-character-encoding}](#character-encoding-file-format-hurl-file-character-encoding)
    - [File Extension {#file-format-hurl-file-file-extension}](#file-extension-file-format-hurl-file-file-extension)
    - [Comments {#file-format-hurl-file-comments}](#comments-file-format-hurl-file-comments)
    - [Special Characters in Strings {#file-format-hurl-file-special-characters-in-strings}](#special-characters-in-strings-file-format-hurl-file-special-characters-in-strings)
  - [Entry {#file-format-entry-entry}](#entry-file-format-entry-entry)
    - [Definition {#file-format-entry-definition}](#definition-file-format-entry-definition)
    - [Example {#file-format-entry-example}](#example-file-format-entry-example)
    - [Description {#file-format-entry-description}](#description-file-format-entry-description)
      - [Options {#file-format-entry-options}](#options-file-format-entry-options)
      - [Cookie storage {#file-format-entry-cookie-storage}](#cookie-storage-file-format-entry-cookie-storage)
      - [Redirects {#file-format-entry-redirects}](#redirects-file-format-entry-redirects)
      - [Retry {#file-format-entry-retry}](#retry-file-format-entry-retry)
      - [Control flow {#file-format-entry-control-flow}](#control-flow-file-format-entry-control-flow)
  - [Request {#file-format-request-request}](#request-file-format-request-request)
    - [Definition {#file-format-request-definition}](#definition-file-format-request-definition)
    - [Example {#file-format-request-example}](#example-file-format-request-example)
    - [Structure {#file-format-request-structure}](#structure-file-format-request-structure)
    - [Description {#file-format-request-description}](#description-file-format-request-description)
      - [Method {#file-format-request-method}](#method-file-format-request-method)
      - [URL {#file-format-request-url}](#url-file-format-request-url)
      - [Headers {#file-format-request-headers}](#headers-file-format-request-headers)
      - [Options {#file-format-request-options}](#options-file-format-request-options)
      - [Query parameters {#file-format-request-query-parameters}](#query-parameters-file-format-request-query-parameters)
      - [Form parameters {#file-format-request-form-parameters}](#form-parameters-file-format-request-form-parameters)
      - [Multipart Form Data {#file-format-request-multipart-form-data}](#multipart-form-data-file-format-request-multipart-form-data)
      - [Cookies {#file-format-request-cookies}](#cookies-file-format-request-cookies)
      - [Basic Authentication {#file-format-request-basic-authentication}](#basic-authentication-file-format-request-basic-authentication)
      - [Body {#file-format-request-body}](#body-file-format-request-body)
        - [JSON body {#file-format-request-json-body}](#json-body-file-format-request-json-body)
        - [XML body {#file-format-request-xml-body}](#xml-body-file-format-request-xml-body)
        - [GraphQL query {#file-format-request-graphql-query}](#graphql-query-file-format-request-graphql-query)
        - [Multiline string body {#file-format-request-multiline-string-body}](#multiline-string-body-file-format-request-multiline-string-body)
        - [Oneline string body {#file-format-request-oneline-string-body}](#oneline-string-body-file-format-request-oneline-string-body)
        - [Base64 body {#file-format-request-base64-body}](#base64-body-file-format-request-base64-body)
        - [Hex body {#file-format-request-hex-body}](#hex-body-file-format-request-hex-body)
        - [File body {#file-format-request-file-body}](#file-body-file-format-request-file-body)
  - [Response {#file-format-response-response}](#response-file-format-response-response)
    - [Definition {#file-format-response-definition}](#definition-file-format-response-definition)
    - [Example {#file-format-response-example}](#example-file-format-response-example)
    - [Structure {#file-format-response-structure}](#structure-file-format-response-structure)
    - [Capture and Assertion {#file-format-response-capture-and-assertion}](#capture-and-assertion-file-format-response-capture-and-assertion)
      - [Body compression {#file-format-response-body-compression}](#body-compression-file-format-response-body-compression)
    - [Timings {#file-format-response-timings}](#timings-file-format-response-timings)
  - [Capturing Response {#file-format-capturing-response-capturing-response}](#capturing-response-file-format-capturing-response-capturing-response)
    - [Captures {#file-format-capturing-response-captures}](#captures-file-format-capturing-response-captures)
      - [Query {#file-format-capturing-response-query}](#query-file-format-capturing-response-query)
      - [Status capture {#file-format-capturing-response-status-capture}](#status-capture-file-format-capturing-response-status-capture)
      - [Version capture {#file-format-capturing-response-version-capture}](#version-capture-file-format-capturing-response-version-capture)
      - [Header capture {#file-format-capturing-response-header-capture}](#header-capture-file-format-capturing-response-header-capture)
      - [Cookie capture {#file-format-capturing-response-cookie-capture}](#cookie-capture-file-format-capturing-response-cookie-capture)
      - [Body capture {#file-format-capturing-response-body-capture}](#body-capture-file-format-capturing-response-body-capture)
      - [Bytes capture {#file-format-capturing-response-bytes-capture}](#bytes-capture-file-format-capturing-response-bytes-capture)
      - [XPath capture {#file-format-capturing-response-xpath-capture}](#xpath-capture-file-format-capturing-response-xpath-capture)
      - [JSONPath capture {#file-format-capturing-response-jsonpath-capture}](#jsonpath-capture-file-format-capturing-response-jsonpath-capture)
      - [Regex capture {#file-format-capturing-response-regex-capture}](#regex-capture-file-format-capturing-response-regex-capture)
      - [SHA-256 capture {#file-format-capturing-response-sha-256-capture}](#sha-256-capture-file-format-capturing-response-sha-256-capture)
      - [MD5 capture {#file-format-capturing-response-md5-capture}](#md5-capture-file-format-capturing-response-md5-capture)
      - [URL capture {#file-format-capturing-response-url-capture}](#url-capture-file-format-capturing-response-url-capture)
      - [Redirects capture {#file-format-capturing-response-redirects-capture}](#redirects-capture-file-format-capturing-response-redirects-capture)
      - [IP address capture {#file-format-capturing-response-ip-address-capture}](#ip-address-capture-file-format-capturing-response-ip-address-capture)
      - [Variable capture {#file-format-capturing-response-variable-capture}](#variable-capture-file-format-capturing-response-variable-capture)
      - [Duration capture {#file-format-capturing-response-duration-capture}](#duration-capture-file-format-capturing-response-duration-capture)
      - [SSL certificate capture {#file-format-capturing-response-ssl-certificate-capture}](#ssl-certificate-capture-file-format-capturing-response-ssl-certificate-capture)
    - [Redacting Secrets {#file-format-capturing-response-redacting-secrets}](#redacting-secrets-file-format-capturing-response-redacting-secrets)
  - [Asserting Response {#file-format-asserting-response-asserting-response}](#asserting-response-file-format-asserting-response-asserting-response)
    - [Asserts {#file-format-asserting-response-asserts}](#asserts-file-format-asserting-response-asserts)
      - [Structure {#file-format-asserting-response-structure}](#structure-file-format-asserting-response-structure)
    - [Implicit asserts {#file-format-asserting-response-implicit-asserts}](#implicit-asserts-file-format-asserting-response-implicit-asserts)
      - [Version - Status {#file-format-asserting-response-version-status}](#version---status-file-format-asserting-response-version-status)
      - [Headers {#file-format-asserting-response-headers}](#headers-file-format-asserting-response-headers)
      - [Body {#file-format-asserting-response-body}](#body-file-format-asserting-response-body)
        - [JSON body {#file-format-asserting-response-json-body}](#json-body-file-format-asserting-response-json-body)
        - [XML body {#file-format-asserting-response-xml-body}](#xml-body-file-format-asserting-response-xml-body)
        - [Multiline string body {#file-format-asserting-response-multiline-string-body}](#multiline-string-body-file-format-asserting-response-multiline-string-body)
          - [Oneline string body {#file-format-asserting-response-oneline-string-body}](#oneline-string-body-file-format-asserting-response-oneline-string-body)
        - [Base64 body {#file-format-asserting-response-base64-body}](#base64-body-file-format-asserting-response-base64-body)
        - [File body {#file-format-asserting-response-file-body}](#file-body-file-format-asserting-response-file-body)
    - [Explicit asserts {#file-format-asserting-response-explicit-asserts}](#explicit-asserts-file-format-asserting-response-explicit-asserts)
      - [Predicates {#file-format-asserting-response-predicates}](#predicates-file-format-asserting-response-predicates)
      - [Status assert {#file-format-asserting-response-status-assert}](#status-assert-file-format-asserting-response-status-assert)
      - [Version assert {#file-format-asserting-response-version-assert}](#version-assert-file-format-asserting-response-version-assert)
      - [Header assert {#file-format-asserting-response-header-assert}](#header-assert-file-format-asserting-response-header-assert)
      - [Cookie assert {#file-format-asserting-response-cookie-assert}](#cookie-assert-file-format-asserting-response-cookie-assert)
      - [Body assert {#file-format-asserting-response-body-assert}](#body-assert-file-format-asserting-response-body-assert)
      - [Bytes assert {#file-format-asserting-response-bytes-assert}](#bytes-assert-file-format-asserting-response-bytes-assert)
      - [XPath assert {#file-format-asserting-response-xpath-assert}](#xpath-assert-file-format-asserting-response-xpath-assert)
      - [JSONPath assert {#file-format-asserting-response-jsonpath-assert}](#jsonpath-assert-file-format-asserting-response-jsonpath-assert)
      - [Regex assert {#file-format-asserting-response-regex-assert}](#regex-assert-file-format-asserting-response-regex-assert)
      - [SHA-256 assert {#file-format-asserting-response-sha-256-assert}](#sha-256-assert-file-format-asserting-response-sha-256-assert)
      - [MD5 assert {#file-format-asserting-response-md5-assert}](#md5-assert-file-format-asserting-response-md5-assert)
      - [URL assert {#file-format-asserting-response-url-assert}](#url-assert-file-format-asserting-response-url-assert)
      - [Redirects assert {#file-format-asserting-response-redirects-assert}](#redirects-assert-file-format-asserting-response-redirects-assert)
      - [IP address assert {#file-format-asserting-response-ip-address-assert}](#ip-address-assert-file-format-asserting-response-ip-address-assert)
      - [Variable assert {#file-format-asserting-response-variable-assert}](#variable-assert-file-format-asserting-response-variable-assert)
      - [Duration assert {#file-format-asserting-response-duration-assert}](#duration-assert-file-format-asserting-response-duration-assert)
      - [SSL certificate assert {#file-format-asserting-response-ssl-certificate-assert}](#ssl-certificate-assert-file-format-asserting-response-ssl-certificate-assert)
  - [Filters {#file-format-filters-filters}](#filters-file-format-filters-filters)
    - [Definition {#file-format-filters-definition}](#definition-file-format-filters-definition)
    - [Example {#file-format-filters-example}](#example-file-format-filters-example)
    - [Description {#file-format-filters-description}](#description-file-format-filters-description)
      - [base64Decode {#file-format-filters-base64decode}](#base64decode-file-format-filters-base64decode)
      - [base64Encode {#file-format-filters-base64encode}](#base64encode-file-format-filters-base64encode)
      - [base64UrlSafeDecode {#file-format-filters-base64urlsafedecode}](#base64urlsafedecode-file-format-filters-base64urlsafedecode)
      - [base64UrlSafeEncode {#file-format-filters-base64urlsafeencode}](#base64urlsafeencode-file-format-filters-base64urlsafeencode)
      - [count {#file-format-filters-count}](#count-file-format-filters-count)
      - [daysAfterNow {#file-format-filters-daysafternow}](#daysafternow-file-format-filters-daysafternow)
      - [daysBeforeNow {#file-format-filters-daysbeforenow}](#daysbeforenow-file-format-filters-daysbeforenow)
      - [decode {#file-format-filters-decode}](#decode-file-format-filters-decode)
      - [first {#file-format-filters-first}](#first-file-format-filters-first)
      - [dateFormat {#file-format-filters-dateformat}](#dateformat-file-format-filters-dateformat)
      - [htmlEscape {#file-format-filters-htmlescape}](#htmlescape-file-format-filters-htmlescape)
      - [htmlUnescape {#file-format-filters-htmlunescape}](#htmlunescape-file-format-filters-htmlunescape)
      - [jsonpath {#file-format-filters-jsonpath}](#jsonpath-file-format-filters-jsonpath)
      - [last {#file-format-filters-last}](#last-file-format-filters-last)
      - [location {#file-format-filters-location}](#location-file-format-filters-location)
      - [nth {#file-format-filters-nth}](#nth-file-format-filters-nth)
      - [regex {#file-format-filters-regex}](#regex-file-format-filters-regex)
      - [replace {#file-format-filters-replace}](#replace-file-format-filters-replace)
      - [replaceRegex {#file-format-filters-replaceregex}](#replaceregex-file-format-filters-replaceregex)
      - [split {#file-format-filters-split}](#split-file-format-filters-split)
      - [toDate {#file-format-filters-todate}](#todate-file-format-filters-todate)
      - [toFloat {#file-format-filters-tofloat}](#tofloat-file-format-filters-tofloat)
      - [toHex {#file-format-filters-tohex}](#tohex-file-format-filters-tohex)
      - [toInt {#file-format-filters-toint}](#toint-file-format-filters-toint)
      - [toString {#file-format-filters-tostring}](#tostring-file-format-filters-tostring)
      - [urlDecode {#file-format-filters-urldecode}](#urldecode-file-format-filters-urldecode)
      - [urlEncode {#file-format-filters-urlencode}](#urlencode-file-format-filters-urlencode)
      - [urlQueryParam {#file-format-filters-urlqueryparam}](#urlqueryparam-file-format-filters-urlqueryparam)
      - [utf8Decode {#file-format-filters-utf8decode}](#utf8decode-file-format-filters-utf8decode)
      - [utf8Encode {#file-format-filters-utf8encode}](#utf8encode-file-format-filters-utf8encode)
      - [xpath {#file-format-filters-xpath}](#xpath-file-format-filters-xpath)
  - [Templates {#file-format-templates-templates}](#templates-file-format-templates-templates)
    - [Variables {#file-format-templates-variables}](#variables-file-format-templates-variables)
    - [Functions {#file-format-templates-functions}](#functions-file-format-templates-functions)
    - [Types {#file-format-templates-types}](#types-file-format-templates-types)
    - [Injecting Variables {#file-format-templates-injecting-variables}](#injecting-variables-file-format-templates-injecting-variables)
      - [`variable` option {#file-format-templates-variable-option}](#variable-option-file-format-templates-variable-option)
      - [`variables-file` option {#file-format-templates-variables-file-option}](#variables-file-option-file-format-templates-variables-file-option)
      - [Environment variable {#file-format-templates-environment-variable}](#environment-variable-file-format-templates-environment-variable)
      - [Options sections {#file-format-templates-options-sections}](#options-sections-file-format-templates-options-sections)
      - [Secrets {#file-format-templates-secrets}](#secrets-file-format-templates-secrets)
    - [Templating Body {#file-format-templates-templating-body}](#templating-body-file-format-templates-templating-body)
  - [Grammar {#file-format-grammar-grammar}](#grammar-file-format-grammar-grammar)
    - [Definitions {#file-format-grammar-definitions}](#definitions-file-format-grammar-definitions)
    - [Syntax Grammar {#file-format-grammar-syntax-grammar}](#syntax-grammar-file-format-grammar-syntax-grammar)
- [Resources {#resources}](#resources-resources)
  - [License {#resources-license-license}](#license-resources-license-license)
...
but it's still the [curl](https://curl.se) that we love: **fast**, **efficient** and **IPv6 / HTTP/3 ready**.
...
- **time_namelookup**: the time it took from the start until the name resolving was completed. You can use
...
- **time_appconnect**: The time it took from the start until the SSL/SSH/etc connect/handshake to the remote host was
...
Captures are optional values that are **extracted from the HTTP response** and stored in a named variable.
...
| ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ |
| **`==`**         | Query and predicate value are equal                                                                                                                                                                                         | `jsonpath "$.book" == "Dune"`                                                                                      |
| **`!=`**         | Query and predicate value are different                                                                                                                                                                                     | `jsonpath "$.color" != "red"`                                                                                      |
| **`>`**          | Query number or date is greater than predicate value                                                                                                                                                                        | `jsonpath "$.year" > 1978`<br><br>`jsonpath "$.createdAt" toDate "%+"  > {{ a_date }}`                             |
| **`>=`**         | Query number or date is greater than or equal to the predicate value                                                                                                                                                        | `jsonpath "$.year" >= 1978`                                                                                        |
| **`<`**          | Query number or date is less than that predicate value                                                                                                                                                                      | `jsonpath "$.year" < 1978`                                                                                         |
| **`<=`**         | Query number or date is less than or equal to the predicate value                                                                                                                                                           | `jsonpath "$.year" <= 1978`                                                                                        |
| **`startsWith`** | Query starts with the predicate value<br>Value is string or a binary content                                                                                                                                                | `jsonpath "$.movie" startsWith "The"`<br><br>`bytes startsWith hex,efbbbf;`                                        |
| **`endsWith`**   | Query ends with the predicate value<br>Value is string or a binary content                                                                                                                                                  | `jsonpath "$.movie" endsWith "Back"`<br><br>`bytes endsWith hex,ab23456;`                                          |
| **`contains`**   | If query returns a collection of string or numbers, query collection includes the predicate value (string or number)<br>If query returns a string or a binary content, query contains the predicate value (string or bytes) | `jsonpath "$.movie" contains "Empire"`<br><br>`bytes contains hex,beef;`<br><br>`jsonpath "$.numbers" contains 42` |
| **`matches`**    | Part of the query string matches the regex pattern described by the predicate value (see [regex syntax](https://docs.rs/regex/latest/regex/#syntax))                                                                        | `jsonpath "$.release" matches "\\d{4}"`<br><br>`jsonpath "$.release" matches /\d{4}/`                              |
...
| **`isIsoDate`**  | Query string returns a [RFC 3339](https://www.rfc-editor.org/rfc/rfc3339) date (`YYYY-MM-DDTHH:mm:ss.sssZ`)                                                                                                                 | `jsonpath "$.publication_date" isIsoDate`                                                                          |
...
In this example, the query **`jsonpath "$.books[0].name"`** is used in a capture to save data and in an assert to test
...
to process data extracted by queries: that's the purpose of **filters**.

Filters are used to transform value extracted by a query and can be used in asserts and captures to refine data. Filters
**can be chained**, allowing for fine-grained data extraction.
...
_Formerly known as `format`, which is deprecated and will be removed in a future major version._
...
> Secrets **are not redacted** from HTTP responses outputted on standard output as Hurl considers the standard output as
